...
(
    ...
    '[{"apiId":"weather-api-001","apiName":"OpenWeatherMap API","endpoint":"https://api.openweathermap.org/data/2.5/weather","parameters":[{"paramName":"q","paramType":"INPUT","paramDescription":"도시 이름","necessary":true},{"paramName":"appid","paramType":"INPUT","paramDescription":"API 키","necessary":true},{"paramName":"units","paramType":"INPUT","paramDescription":"온도 단위 (metric, imperial)","necessary":false}]},{"apiId":"weather-api-002","apiName":"WeatherAPI","endpoint":"https://api.weatherapi.com/v1/current.json","parameters":[{"paramName":"key","paramType":"INPUT","paramDescription":"API 키","necessary":true},{"paramName":"q","paramType":"INPUT","paramDescription":"위치 정보","necessary":true}]}]',
    TRUE,
    FALSE,
    'ORIGINAL',
    FALSE,
...
(
    ...
    '[{"apiId":"crypto-price-api-001","apiName":"CoinGecko API","endpoint":"https://api.coingecko.com/api/v3/simple/price","parameters":[{"paramName":"ids","paramType":"INPUT","paramDescription":"조회할 코인 목록 (bitcoin,ethereum)","necessary":true},{"paramName":"vs_currencies","paramType":"INPUT","paramDescription":"기준 통화 (usd,krw)","necessary":true},{"paramName":"price_data","paramType":"OUTPUT","paramDescription":"코인별 가격 정보","necessary":false}]},{"apiId":"crypto-price-api-002","apiName":"Binance API","endpoint":"https://api.binance.com/api/v3/ticker/price","parameters":[{"paramName":"symbol","paramType":"INPUT","paramDescription":"거래 심볼 (BTCUSDT)","necessary":false},{"paramName":"price","paramType":"OUTPUT","paramDescription":"현재 가격","necessary":false}]}]',
    TRUE,
    FALSE,
    'ORIGINAL',
    FALSE,
