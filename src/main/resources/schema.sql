...
CREATE TABLE IF NOT EXISTS custom_api (
    ...
    origin_api_id VARCHAR(36) COMMENT '원본 API ID (LINK 타입인 경우)',
    ...
    -- Foreign Keys
    CONSTRAINT fk_custom_api_origin FOREIGN KEY (origin_api_id) REFERENCES custom_api(custom_api_id) ON DELETE SET NULL,
